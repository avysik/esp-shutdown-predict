...
def generate(
    ...
    ipr_mode: str = typer.Option("linear-pi", help="IPR mode: linear-pi | vogel-test-point"),
    p_res_atma: Optional[float] = typer.Option(None, help="Reservoir pressure for IPR, atma"),
    productivity_index: Optional[float] = typer.Option(None, help="Productivity index J, sm3/day/atma"),
